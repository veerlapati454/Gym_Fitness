      ...
      <div className="footer-container">
        ...
        <div className="footer-col brand-col">
          ...
          <p className="brand-desc">
            Premium fitness center dedicated to helping you achieve your body goals. Real training, real results.
          </p>
        ...
        <div className="footer-col newsletter-col">
          <h3>Newsletter</h3>
          <p>Subscribe to get updates on programs, discounts, and fitness tips.</p>
